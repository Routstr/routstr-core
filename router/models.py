...
def load_models() -> list[Model]:
    ...
    try:
        ...
        logger.error("Error loading models from %s: %s", models_path, e)
        return []
            ...
            for model in MODELS:
                ...
                if model.top_provider:
                    if (
                        ...
                        max_context_cost = (
                            model.top_provider.context_length * model.sats_pricing.prompt
                        )
                        max_completion_cost = (
                            model.top_provider.max_completion_tokens * model.sats_pricing.completion
                        )
