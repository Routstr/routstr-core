    ...
    5235: (t, e, s) => {
      ...
      var i = s(9205),
        ...
        u = class extends n.Q {
          ...
          add(t) {
            this.#r.has(t.queryHash) ||
              (this.#r.set(t.queryHash, t),
            ...
            let a = e.options,
              ...
              l = async () => {
                let s = !1,
                  ...
                  c = (0, i.ZM)(e.options, e.fetchOptions),
                  d = async (t, a, r) => {
                ...
                if (r && n.length) {
                  ...
                  let e = t ?? n.length;
                  do {
                    let t = 0 === h ? (u[0] ?? a.initialPageParam) : y(a, o);
                    if (h > 0 && null == t) break;
                    ((o = await d(o, t)), h++);
                  } while (h < e);
                }
      ...
      function y(t, { pages: e, pageParams: s }) {
        let i = e.length - 1;
      ...
      var p = class {
        ...
        fetchInfiniteQuery(t) {
          return ((t.behavior = f(t.pages)), this.fetchQuery(t));
        }
        prefetchInfiniteQuery(t) {
          return this.fetchInfiniteQuery(t).then(i.lQ).catch(i.lQ);
        }
        ensureInfiniteQueryData(t) {
          return ((t.behavior = f(t.pages)), this.ensureQueryData(t));
        }
        resumePausedMutations() {
          return d.t.isOnline()
