(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [177],
  {
    ...
    3372: (e, t, r) => {
      (Promise.resolve().then(r.bind(r, 5414)),
        Promise.resolve().then(r.t.bind(r, 8368, 23)),
        Promise.resolve().then(r.t.bind(r, 7248, 23)),
        Promise.resolve().then(r.t.bind(r, 8770, 23)));
    },
    5414: (e, t, r) => {
      'use strict';
      r.d(t, { Providers: () => w });
      var a = r(3422),
        ...
        l = r(7916);
      class u {
        static async listUsers(e) {
          try {
            let t = {};
            return (
              e && (t.organization_id = e),
              await l.apiClient.get('/api/users', t)
            );
          } catch (e) {
        ...
        static async getUser(e) {
          try {
            return await l.apiClient.get('/api/users/'.concat(e));
          } catch (t) {
            throw (console.error('Error fetching user '.concat(e, ':'), t), t);
          }
        }
        static async createUser(e) {
          try {
            return await l.apiClient.post('/api/users', e);
          } catch (e) {
            throw (console.error('Error creating user:', e), e);
          }
        }
        static async updateUser(e, t) {
          try {
            return await l.apiClient.put('/api/users/'.concat(e), t);
          } catch (t) {
            throw (console.error('Error updating user '.concat(e, ':'), t), t);
          }
        }
        static async deleteUser(e) {
          try {
            await l.apiClient.delete('/api/users/'.concat(e));
          } catch (t) {
            throw (console.error('Error deleting user '.concat(e, ':'), t), t);
          }
        }
      }
      ...
      function h(e) {
        let { children: t } = e,
          ...
          p = async () => {
            try {
              if (!('nostr' in window))
                return (console.error('Nostr extension not found'), null);
              {
                let e = await window.nostr.getPublicKey();
                return (g(e), localStorage.setItem('nostr_public_key', e), e);
              }
            } catch (e) {
              return (console.error('Error connecting to Nostr:', e), null);
            }
          },
          y = async () => {
            (s(!0), l(null));
            try {
              let e = await u.getUser('1');
              if (!e) throw Error('Admin user not found');
              (n(e),
                localStorage.setItem('auth_user', JSON.stringify(e)),
                h || (await p()));
            } catch (e) {
              throw (l(e instanceof Error ? e : Error('Sign in failed')), e);
            } finally {
              s(!1);
            }
          };
        return (0, a.jsx)(d.Provider, {
          value: {
            ...
            signin: y,
            signout: () => {
              (n(null), localStorage.removeItem('auth_user'));
            },
            connectNostr: p,
          },
          children: t,
      ...
      function y(e) {
        ...
        return (
          (0, i.useEffect)(() => {
            ['/login', '/_register', '/unauthorized'].some((e) =>
              n.startsWith(e)
            ) ||
              p.s.isTokenValid() ||
              r.push('/login');
      ...
      function w(e) {
        ...
        return (0, a.jsxs)(o.Ht, {
          client: r,
          children: [
            (0, a.jsx)(h, {
              children: (0, a.jsxs)(y, {
                children: [t, (0, a.jsx)(c.l$, { position: 'top-right' })],
              }),
            }),
            (0, a.jsx)(s.E, { initialIsOpen: !1 }),
          ],
        });
      }
    },
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    (e.O(0, [699, 273, 363, 29, 578, 945, 497, 358], () => t(3372)),
      (_N_E = e.O()));
  },
]);
