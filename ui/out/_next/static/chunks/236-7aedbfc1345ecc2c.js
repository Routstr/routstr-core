...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [236],
  {
    ...
    953: (e, t, a) => {
      ...
      function h(e) {
        let { ...t } = e;
        return (0, r.jsx)(c.bL, { 'data-slot': 'sheet', ...t });
      }
      function g(e) {
        let { ...t } = e;
        return (0, r.jsx)(c.ZL, { 'data-slot': 'sheet-portal', ...t });
      }
      function p(e) {
        let { className: t, ...a } = e;
        return (0, r.jsx)(c.hJ, {
      ...
      function f(e) {
        let { className: t, children: a, side: n = 'right', ...i } = e;
        return (0, r.jsxs)(g, {
          children: [
            (0, r.jsx)(p, {}),
            (0, r.jsxs)(c.UC, {
      ...
      function m(e) {
        ...
        return (0, r.jsx)('div', {
          ...
          className: (0, l.cn)('flex flex-col gap-1.5 p-4', t),
          ...a,
        });
      }
      function b(e) {
        ...
        return (0, r.jsx)(c.hE, {
          ...
          className: (0, l.cn)('text-foreground font-semibold', t),
          ...a,
        });
      }
      function v(e) {
      ...
      function j(e) {
        let {
          ...
          v = n.useCallback(() => (u ? g((e) => !e) : b((e) => !e)), [u, b, g]);
        n.useEffect(() => {
          let e = (e) => {
            'b' === e.key &&
              (e.metaKey || e.ctrlKey) &&
      ...
      function k(e) {
        let {
          ...
          { isMobile: d, state: c, openMobile: u, setOpenMobile: g } = y();
        return 'none' === n
          ? (0, r.jsx)('div', {
              'data-slot': 'sidebar',
              className: (0, l.cn)(
      ...
      function S(e) {
        ...
        return (0, r.jsx)('div', {
          ...
          'data-sidebar': 'header',
          className: (0, l.cn)('flex flex-col gap-2 p-2', t),
          ...a,
        });
      }
      function C(e) {
      ...
      function A(e) {
        ...
        return (0, r.jsx)('div', {
          ...
          'data-sidebar': 'group',
          className: (0, l.cn)('relative flex w-full min-w-0 flex-col p-2', t),
          ...a,
        });
      }
      function I(e) {
        ...
        return (0, r.jsx)('div', {
          ...
          className: (0, l.cn)('w-full text-sm', t),
          ...a,
        });
      }
      function z(e) {
        ...
        return (0, r.jsx)('ul', {
          ...
          'data-sidebar': 'menu',
          className: (0, l.cn)('flex w-full min-w-0 flex-col gap-1', t),
          ...a,
        });
      }
      function B(e) {
        ...
        return (0, r.jsx)('li', {
          ...
          className: (0, l.cn)('group/menu-item relative', t),
          ...a,
        });
      }
      let E = (0, o.F)(
      ...
      function U(e) {
        let {
          ...
          u = t ? i.DX : 'button',
          { isMobile: h, state: g } = y(),
          p = (0, r.jsx)(u, {
            'data-slot': 'sidebar-menu-button',
            'data-sidebar': 'menu-button',
            'data-size': o,
            'data-active': a,
            className: (0, l.cn)(E({ variant: n, size: o }), d),
            ...c,
          });
        return s
          ? ('string' == typeof s && (s = { children: s }),
            (0, r.jsxs)(x.m_, {
              children: [
                (0, r.jsx)(x.k$, { asChild: !0, children: p }),
                (0, r.jsx)(x.ZI, {
                  side: 'right',
                  align: 'center',
                  hidden: 'collapsed' !== g || h,
                  ...s,
                }),
              ],
            }))
    ...
    2745: (e, t, a) => {
      ...
      function i(e) {
        ...
        return (0, r.jsx)('div', {
          'data-slot': 'skeleton',
          className: (0, n.cn)('bg-accent animate-pulse rounded-md', t),
          ...a,
        });
      }
    },
    3234: (e, t, a) => {
      ...
      class i {
          ...
          try {
            {
              let t = localStorage.getItem('admin_token'),
                a = localStorage.getItem('admin_token_expiry');
              if (t && a) {
                let r = parseInt(a, 10);
                if (Date.now() < r)
        ...
        static setToken(e, t) {
          let a = Date.now() + 1e3 * t;
          (localStorage.setItem('admin_token', e),
            localStorage.setItem('admin_token_expiry', String(a)));
        }
        ...
        static async saveServerConfigToBackend(e) {
          try {
            ...
            let t = this.getLocalBaseUrl(),
              a = { endpoint: e.endpoint, api_key: e.apiKey };
            return (
              await n.A.post(''.concat(t, '/api/server-config'), a, {
                headers: { 'Content-Type': 'application/json' },
              }),
              !0
            );
        ...
        static async requestNewApiKey(e) {
          try {
            ...
            if (a.data && a.data.api_key) return a.data.api_key;
    ...
    3270: (e, t, a) => {
      ...
      async function o(e) {
        try {
          ...
          return (
            a.data.token &&
              a.data.expires_in &&
              n.s.setToken(a.data.token, a.data.expires_in),
            a.data
          );
        } catch (e) {
      ...
      (r.Ik({ username: r.Yj().optional(), password: r.Yj().optional() }),
        r.Ik({ id: r.Yj() }),
        r.Ik({ password: r.Yj().min(1, 'Password is required') }),
        r.Ik({ ok: r.zM(), token: r.Yj(), expires_in: r.ai() }),
        r.Ik({
          npub: r.Yj().min(10, { message: 'must have at least 10 character' }),
          name: r.Yj().optional(),
        }),
        r.Ik({ user_id: r.Yj(), theme: r.Yj() }));
    },
    3648: (e, t, a) => {
      a.d(t, { $: () => l, r: () => s });
      var r = a(3422);
      ...
      function l(e) {
        let { className: t, variant: a, size: i, asChild: l = !1, ...d } = e,
          c = l ? n.DX : 'button';
        return (0, r.jsx)(c, {
          'data-slot': 'button',
          className: (0, o.cn)(s({ variant: a, size: i, className: t })),
          ...d,
        });
      }
    },
      ...
      function u() {
        let e = (0, l.useRouter)(),
          t = async () => {
            try {
              (await (0, d.wu)(),
                c.oR.success('Logged out successfully'),
                e.push('/login'));
            } catch (e) {
              (console.error('Logout error:', e),
                c.oR.error('Failed to logout'));
            }
          };
        return (0, r.jsx)('header', {
          ...
          children: (0, r.jsxs)('div', {
            className:
              'flex w-full items-center justify-between gap-1 px-4 lg:gap-2 lg:px-6',
            children: [
              (0, r.jsxs)('div', {
                className: 'flex items-center gap-1 lg:gap-2',
                children: [
                  (0, r.jsx)(i.x2, { className: '-ml-1' }),
                  (0, r.jsx)(n.w, {
    ...
    6545: (e, t, a) => {
      ...
      function s(e) {
        let { ...t } = e;
        return (0, r.jsx)(o, {
          children: (0, r.jsx)(n.bL, { 'data-slot': 'tooltip', ...t }),
        });
      }
      function l(e) {
        let { ...t } = e;
        return (0, r.jsx)(n.l9, { 'data-slot': 'tooltip-trigger', ...t });
      }
      function d(e) {
        let { className: t, sideOffset: a = 0, children: o, ...s } = e;
        return (0, r.jsx)(n.ZL, {
    ...
    7569: (e, t, a) => {
      ...
      function u(e) {
        ...
        return (0, r.jsx)(c.Cn, {
          ...a,
          children: (0, r.jsx)(c.rQ, {
            children: (0, r.jsx)(c.wZ, {
              children: t.map((e) =>
                (0, r.jsx)(
                  c.FX,
                  {
                    children: (0, r.jsx)(c.Uj, {
                      asChild: !0,
                      children: (0, r.jsxs)(d(), {
                        href: e.url,
                        children: [
      ...
      let h = {
        navMain: [{ title: 'Dashboard', url: '/', icon: n.A }],
        navClouds: [],
        navSecondary: [
          { title: 'Dashboard', url: '/', icon: n.A },
          { title: 'Models', url: '/models', icon: i.A },
          { title: 'Providers', url: '/providers', icon: o.A },
          { title: 'Settings', url: '/settings', icon: s.A },
        ],
        documents: [],
      };
      function g(e) {
        let { ...t } = e;
        return (0, r.jsxs)(c.Bx, {
          collapsible: 'offcanvas',
          ...t,
          children: [
            (0, r.jsx)(c.Gh, {
              children: (0, r.jsx)(c.wZ, {
                children: (0, r.jsx)(c.FX, {
                  children: (0, r.jsx)(c.Uj, {
                    asChild: !0,
    ...
    7916: (e, t, a) => {
      ...
      class i {
        ...
        handleAuthError(e) {
          if (r.A.isAxiosError(e)) {
            var t, a;
            ((null == (t = e.response) ? void 0 : t.status) === 401 ||
              (null == (a = e.response) ? void 0 : a.status) === 403) &&
        ...
        async get(e, t) {
          ...
          try {
            return (
              ...
              (await r.A.get(''.concat(this.getBaseUrl()).concat(e), a)).data
            );
          } catch (e) {
        ...
        async post(e, t) {
          let a = { headers: this.getHeaders(), withCredentials: !1 };
          try {
            return (
              console.log(
              ...
              (await r.A.post(''.concat(this.getBaseUrl()).concat(e), t, a))
                .data
            );
          } catch (t) {
            throw (
        ...
        async put(e, t) {
          ...
          try {
            return (
              ...
              (await r.A.put(''.concat(this.getBaseUrl()).concat(e), t, a)).data
            );
          } catch (t) {
            throw (
              this.handleAuthError(t),
        ...
        async patch(e, t) {
          ...
          try {
            return (
              ...
              (await r.A.patch(''.concat(this.getBaseUrl()).concat(e), t, a))
                .data
            );
          } catch (t) {
            throw (
        ...
        async delete(e) {
          ...
          try {
            return (
              ...
              (await r.A.delete(''.concat(this.getBaseUrl()).concat(e), t)).data
            );
          } catch (t) {
            throw (
              this.handleAuthError(t),
