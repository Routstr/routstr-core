  ...
  [222],
  {
    ...
    4966: (e, r, o) => {
      ...
      let x = (e) => {
        ...
        I = (e) => e.endsWith('%') && P(e.slice(0, -1)),
        S = (e) => j.test(e),
        G = () => !0,
        O = (e) => N.test(e) && !C.test(e),
        W = () => !1,
        A = (e) => E.test(e),
        R = (e) => $.test(e),
        V = (e) => !T(e) && !X(e),
      ...
      let ed = (function (e, ...r) {
        ...
        let e = w('color'),
          ...
          N = () => [X, T, i],
          C = () => [M, 'full', 'auto', ...N()],
          E = () => [_, 'none', 'subgrid', X, T],
          $ = () => ['auto', { span: ['full', _, X, T] }, _, X, T],
          O = () => [_, 'auto', X, T],
          W = () => ['auto', 'min', 'max', 'fr', X, T],
          A = () => [
            'start',
            'end',
            'center',
          ...
          eo = () => [e, X, T],
          et = () => [...y(), J, B, { position: [X, T] }],
          en = () => [
            'no-repeat',
            { repeat: ['', 'x', 'y', 'space', 'round'] },
          ],
          ea = () => ['auto', 'cover', 'contain', K, D, { size: [X, T] }],
          el = () => [I, Z, F],
          es = () => ['', 'none', 'full', d, X, T],
          ei = () => ['', P, Z, F],
        ...
        return {
          ...
          classGroups: {
            aspect: [{ aspect: ['auto', 'square', M, T, X, g] }],
            container: ['container'],
            columns: [{ columns: [P, T, X, s] }],
            ...
            flex: [{ flex: [P, M, 'auto', 'initial', 'none', T] }],
            grow: [{ grow: ['', P, X, T] }],
            shrink: [{ shrink: ['', P, X, T] }],
            order: [{ order: [_, 'first', 'last', 'none', X, T] }],
            ...
            tracking: [{ tracking: [n, X, T] }],
            'line-clamp': [{ 'line-clamp': [P, 'none', X, q] }],
            leading: [{ leading: [a, ...N()] }],
            'list-image': [{ 'list-image': ['none', X, T] }],
            'list-style-position': [{ list: ['inside', 'outside'] }],
            'list-style-type': [{ list: ['disc', 'decimal', 'none', X, T] }],
            'text-alignment': [
            ...
            'text-decoration-thickness': [
              { decoration: [P, 'from-font', 'auto', X, F] },
            ],
            'text-decoration-color': [{ decoration: eo() }],
            'underline-offset': [{ 'underline-offset': [P, 'auto', X, T] }],
            'text-transform': [
              'uppercase',
              'lowercase',
              'capitalize',
            ...
            'outline-offset': [{ 'outline-offset': [P, X, T] }],
            'outline-w': [{ outline: ['', P, Z, F] }],
            ...
            'mask-image-radial': [{ 'mask-radial': [X, T] }],
            ...
            'mask-image': [{ mask: ['none', X, T] }],
            filter: [{ filter: ['', 'none', X, T] }],
            blur: [{ blur: ep() }],
            brightness: [{ brightness: [P, X, T] }],
            contrast: [{ contrast: [P, X, T] }],
            'drop-shadow': [{ 'drop-shadow': ['', 'none', u, Y, Q] }],
            'drop-shadow-color': [{ 'drop-shadow': eo() }],
            grayscale: [{ grayscale: ['', P, X, T] }],
            'hue-rotate': [{ 'hue-rotate': [P, X, T] }],
            invert: [{ invert: ['', P, X, T] }],
            saturate: [{ saturate: [P, X, T] }],
            sepia: [{ sepia: ['', P, X, T] }],
            'backdrop-filter': [{ 'backdrop-filter': ['', 'none', X, T] }],
            'backdrop-blur': [{ 'backdrop-blur': ep() }],
            'backdrop-brightness': [{ 'backdrop-brightness': [P, X, T] }],
            'backdrop-contrast': [{ 'backdrop-contrast': [P, X, T] }],
            'backdrop-grayscale': [{ 'backdrop-grayscale': ['', P, X, T] }],
            'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [P, X, T] }],
            'backdrop-invert': [{ 'backdrop-invert': ['', P, X, T] }],
            'backdrop-opacity': [{ 'backdrop-opacity': [P, X, T] }],
            'backdrop-saturate': [{ 'backdrop-saturate': [P, X, T] }],
            'backdrop-sepia': [{ 'backdrop-sepia': ['', P, X, T] }],
            ...
            duration: [{ duration: [P, 'initial', X, T] }],
            ease: [{ ease: ['linear', 'initial', h, X, T] }],
            delay: [{ delay: [P, X, T] }],
            animate: [{ animate: ['none', k, X, T] }],
            backface: [{ backface: ['hidden', 'visible'] }],
            perspective: [{ perspective: [b, X, T] }],
            ...
            'skew-x': [{ 'skew-x': eb() }],
            'skew-y': [{ 'skew-y': eb() }],
            transform: [{ transform: [X, T, '', 'none', 'gpu', 'cpu'] }],
