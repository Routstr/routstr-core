...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("input_observed", sa.Boolean(), nullable=True),
        sa.Column("output_observed", sa.Boolean(), nullable=True),
        sa.Column("cache_read_observed", sa.Boolean(), nullable=True),
        sa.Column("cache_creation_observed", sa.Boolean(), nullable=True),
